          ...
          {[
            {
              ...
              answer:
                'Recovery coaching is a collaborative partnership focused on supporting you to set and achieve your personal recovery goals. Unlike therapy, which often explores past experiences and mental health diagnoses, coaching is future-focused and practical. I provide tools, accountability, and encouragement to help you build new habits, strengthen your mindset, and live the life you want beyond your eating disorder.'
            },
            {
              question: 'How often do we meet, and what do the sessions involve?',
              answer:
                'We typically meet once a week via online video calls, but the schedule can be tailored to fit your needs. Each session is personalised, focusing on your goals and challenges at that moment. We might discuss meal planning, coping strategies, mindset shifts, or anything else relevant to your recovery journey. '
            },
            {
            ...
            },
            {
              ...
              answer:
              'If you want to recover and make changes, are open to learning new tools, and want structured support without judgment, coaching could be a great fit. The best way to find out is to schedule a free discovery call where we can discuss your goals and see how I can best support you.'
            }
          ].map((item, index) => (
            <Accordion
              key={index}
